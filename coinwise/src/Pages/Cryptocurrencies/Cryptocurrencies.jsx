...
const Cryptocurrencies = ({ simplified, count=100 }) => {
  ...
  return (
    <div className={`${!simplified ? 'min-h-[96.5vh]' : ''}`}>
      ...
      <div key={coin.uuid} className='shadow-customShadow py-5 px-6 bg-white transform transition-transform duration-300 hover:scale-105'><Link to={`/crypto/${coin.uuid}`}>
